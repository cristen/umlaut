...
var Actor, Association, Browser, Case, Database, Decision, Delay, Diagram, Document, Element, Ellipsis, Flow, FlowChart, HardDisk, IO, Inheritance, InternalStorage, Link, Lozenge, ManualInput, Mockup, Mockups, Mouse, Phone, Preparation, Process, Rect, SubProcess, Svg, Terminator, Use, UseCase, commands, dist, edit, element_add, generate_url, history_pop, init_commands, link_add, list_diagrams, load, mouse_xy, save, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
Mockup = (function() {
  function Mockup(x, y, text, fixed) {
    var _this = this;
    this.x = x;
    this.y = y;
    this.text = text;
  ...
  Mockup.prototype.set_txt_bbox = function(bbox) {
    return this._txt_bbox = bbox;
  };

  Mockup.prototype.txt_width = function() {
    return this._txt_bbox.width + 2 * this.margin.x;
  };

  Mockup.prototype.txt_height = function() {
    return this._txt_bbox.height + 2 * this.margin.y;
  };

  Mockup.prototype.txt_x = function() {
    return 0;
  };

  Mockup.prototype.txt_y = function() {
    return -this._txt_bbox.height / 2;
  };

  Mockup.prototype.width = function() {
    return this.txt_width();
  };

  Mockup.prototype.height = function() {
    return this.txt_height();
  };

  Mockup.prototype.direction = function(x, y) {
    var delta;
    delta = this.height() / this.width();
    if (this.x <= x && this.y <= y) {
      if (y > delta * (x - this.x) + this.y) {
  ...
  Mockup.prototype.objectify = function() {
    return {
      name: this.constructor.name,
      x: this.x,
      y: this.y,
...
Use = (function(_super) {
  ...
  function Use() {
    Use.__super__.constructor.call(this);
    this.parent = Mockup;
    this.text = "";
    this.id = "#fallout";
  }

  Use.prototype.txt_x = function() {
    return Use.__super__.txt_x.call(this) - this.height() / 4 + this.txt_height() / 6;
  };

  Use.prototype.txt_width = function() {
    return Math.max(0, Use.__super__.txt_width.call(this) - this.txt_height() / 3);
  };

  Use.prototype.pos = function() {
    return {
      x: this.x,
      y: this.y
    };
  ...
  Use.prototype.href = function() {
    return this.href;
  };

  Use.prototype.path = function() {
    var bottom;
    return bottom = this.height() / 2 - this.txt_height() + this.margin.y;
  };
...
Phone = (function(_super) {
  ...
  function Phone() {
    Phone.__super__.constructor.call(this);
    this.id = "#phone";
  }
...
Mockups = (function(_super) {
  __extends(Mockups, _super);

  Mockups.prototype.label = 'Mockups diagrams';

  function Mockups() {
    Mockups.__super__.constructor.call(this);
...
Svg = (function() {
  function Svg() {
    ...
    this.defs.append('image').attr('id', 'fallout').attr('xlink:href', "http://www.fallout-3.com/files/images/Childkiller_Unused_0.jpg").attr('x', 10).attr('y', 10).attr('width', '300px').attr('height', '300px');
    this.defs.append('image').attr('id', 'phone').attr('xlink:href', "assets/dessin.svg").attr('x', 10).attr('y', 10).attr('width', '121').attr('height', '226');
    this.defs.append('image').attr('id', 'browser').attr('xlink:href', "assets/browser.svg").attr('x', 10).attr('y', 10).attr('width', '700').attr('height', '750');
  ...
  Svg.prototype.sync = function() {
    var element_g, elt, link_g, _i, _len, _ref18,
      _this = this;
    ...
    this.use = this.element.select('use').attr('xlink:href', function(elt) {
      return elt.id;
    });
    _ref18 = this.use.data();
    for (_i = 0, _len = _ref18.length; _i < _len; _i++) {
      elt = _ref18[_i];
      if (elt.parent.name === "Mockup") {
        this.element.select('path').remove();
        this.element.select('text').remove();
      } else {
        this.element.select('use').remove();
      }
    }
